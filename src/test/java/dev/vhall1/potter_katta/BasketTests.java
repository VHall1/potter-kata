...
public class BasketTests {
    ...
    class NoDiscount {
        ...
        void singleBook() {
            Basket basket = new Basket(List.of(1));
        ...
        void threeRepeatedBooks() {
            Basket basket = new Basket(List.of(1, 1, 1));
    ...
    class NoRepeatDiscounts {
        ...
        void twoBooks() {
            Basket basket = new Basket(List.of(0, 1));
        ...
        void threeBooks() {
            Basket basket = new Basket(List.of(0, 2, 4));
        ...
        void fourBooks() {
            Basket basket = new Basket(List.of(0, 1, 2, 4));
        ...
        void fiveBooks() {
            Basket basket = new Basket(List.of(0, 1, 2, 3, 4));
    ...
    class RepeatDiscounts {
        ...
        void twoUniqueBooksPlusOne() {
            Basket basket = new Basket(List.of(0, 0, 1));
        ...
        void twoUniqueBooksPlusTwo() {
            Basket basket = new Basket(List.of(0, 0, 1, 1));
        ...
        void fourUniqueBooksPlusTwo() {
            Basket basket = new Basket(List.of(0, 0, 1, 2, 2, 3));
        ...
        void fiveUniqueBooksPlusOne() {
            Basket basket = new Basket(List.of(0, 1, 1, 2, 3, 4));
